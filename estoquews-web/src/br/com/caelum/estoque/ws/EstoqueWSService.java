 ...
 * 2018-02-27T11:32:38.606-03:00
 * Generated source version: 3.1.6
 * 
 */
@WebServiceClient(name = "EstoqueWSService", 
                  wsdlLocation = "file:/E:/Projetos/Workspace/estoquews-web/src/EstoqueWSServiceCap5.wsdl",
...
public class EstoqueWSService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/E:/Projetos/Workspace/estoquews-web/src/EstoqueWSServiceCap5.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(EstoqueWSService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "file:/E:/Projetos/Workspace/estoquews-web/src/EstoqueWSServiceCap5.wsdl");
        }
        WSDL_LOCATION = url;
    }
